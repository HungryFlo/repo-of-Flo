...
public interface List<T> {
     ...
     * Postcondition:
     * Removes the element marked by the cursor from a list
     * and reinserts it as the nth element in the list,
     * where the elements are numbered from beginning to end,
     * starting with zero. Moves the cursor to the moved element.
     */
     ...
     * List is not empty.
     * Postcondition:
     * Searches a list for searchElement.
     * Begins the search with the element marked by the cursor.
     * Moves the cursor through the list until either searchElement
     * is found (returns true) or the end of the list is reached
     * without finding searchElement (returns false).
     * Leaves the cursor at the last element visited
     * during the search.
     */
